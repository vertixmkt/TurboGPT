...
var GLASS_CONTROL_BG = 'rgba(255,255,255,0.07)';
  ...
  return (
    <article
      ...
      <button type="button" onClick={onOpen} className="flex min-h-0 flex-1 flex-col text-left">
        ...
        <span className="block pt-6">
          <h3 className="line-clamp-2 text-lg font-bold leading-snug" style={{ color: '#fff' }}>{item.name}</h3>
          {item.description ? <p className="mt-2 line-clamp-4 text-sm leading-relaxed" style={{ color: '#888' }}>{item.description}</p> : null}
        </span>
      </button>
